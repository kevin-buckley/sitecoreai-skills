---
name: sitecoreai-content-migration
description: >-
  ...
  sitecoreai-migration-playbook for sequencing. Common phrasings: migrate content, content
...
- Module IDs follow `<site>-content` / `<site>-global-content` for content modules. See `sitecoreai-migration-playbook` for the full naming convention.
