---
name: sitecore-component-migration
description: >-
  Rebuild an XP rendering - SXA components, rendering variants, datasource-driven UI, and presentation
  behavior - as a Sitecore XM Cloud Json Rendering plus a Content SDK React component. Use when
  migrating a component or rendering from XP to XM Cloud, collapsing SXA rendering variants into
  React, handling one rendering reused across mixed datasource shapes, or deciding how a datasource
  template and rendering item should be recreated. For overall sequencing use
  sitecore-migration-playbook; for the content model use sitecore-template-migration.
license: Apache-2.0
