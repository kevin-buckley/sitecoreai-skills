...
description: >-
  ...
  sequencing use sitecore-migration-playbook; for the content model use
  sitecore-template-migration. Common phrasings: migrate component, rendering migration, sxa
