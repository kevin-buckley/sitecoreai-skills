...
description: >-
  ...
  sitecoreai-frontend-performance; for project and placeholder architecture use
  sitecoreai-headless-project-structure. Common phrasings: hard-coded values check, naming audit,
