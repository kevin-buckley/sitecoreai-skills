...
description: >-
  ...
  applies next: sitecore-site-migration, sitecore-template-migration,
  sitecore-component-migration, sitecore-content-migration, sitecore-code-migration, or
  sitecore-page-design-setup. Also use when the question is which XP features (xConnect, Sitecore
