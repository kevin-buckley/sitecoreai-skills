---
name: sitecoreai-sxa-datasources-media
description: >-
  ...
  datasources. For the media library as a whole use sitecoreai-media; for where datasources should
  live during a migration use sitecoreai-content-migration. Common phrasings: datasource audit, data
